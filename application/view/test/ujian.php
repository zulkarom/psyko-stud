...
<div class="container">
	<div class="row">
	<div class="col-md-8">
	<div class="ptitle">Ujian Psikometrik
	...
	<br />
	<strong>No. Matrik:</strong>  <?php echo $this->user->matric_no ;?>
	<br />
	<strong>Program:</strong>  <?php echo $this->user->program ;?>
    ...
    <div class="box">
		...
		<a href="<?=Config::get('URL')?>option/ujian" class="btn btn-warning " id="kembali-btn">KEMBALI</a>
		...
		<div align="center">
		<a href="<?=Config::get('URL')?>option/ujian" class="btn btn-warning " id="kembali-btn">KEMBALI</a> <button class="btn btn-success" id="start-btn">MULA MENJAWAB</button>
		</div>
...
var linklogout = "<br /><br /><a href='<?php echo Config::get('URL'); ?>option/ujian'>Kembali</a>";
