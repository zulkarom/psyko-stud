...
class View
{
	...
	public function renderPsi($filename, $data = null)
    {
        if ($data) {
            foreach ($data as $key => $value) {
                $this->{$key} = $value;
        ...
        require Config::get('PATH_VIEW') . '_templates/header_psi.php';
        require Config::get('PATH_VIEW') . $filename . '.php';
        require Config::get('PATH_VIEW') . '_templates/footer.php';
    }
	...
	public function renderAdmin($filename, $data = null)
    {
        ...
        require Config::get('PATH_VIEW') . '_templates_admin/header.php';
		require Config::get('PATH_VIEW') . '_templates_admin/menu.php';
        require Config::get('PATH_VIEW') . $filename . '.php';
        require Config::get('PATH_VIEW') . '_templates_admin/footer.php';
    }
	public function renderPdf($filename, $data = null)
    {
        if ($data) {
            foreach ($data as $key => $value) {
                $this->{$key} = $value;
        ...
        require Config::get('PATH_VIEW') . 'tcpdf/tcpdf.php';
        require Config::get('PATH_VIEW') . $filename . '.php';
    }
